...
const transporter = nodemailer.createTransport({
    ...
    auth: {
        ...
        user: "thejosuescript@gmail.com",
        pass: "tnfs tvuz giqf lzpe"
    },
});
...
async function main() {
    ...
    const info = await transporter.sendMail({
        from: `"Co-Lab Team" <Thejosuescript@gmail.com>`,
        to: "thejosuescript@gmail.com,k3rn23@gmail.com",
        subject: 'Co-Lab Verificacion',
        text: "Verificate ¡Nuevas colaboraciones y proyectos te esperan!",
        ...
        * {
        ...
        <div align="center">
          <!--[if mso]><table border="0" cellspacing="0" cellpadding="0"><tr><td align="center" bgcolor="#14b99f" style="padding:10px 20px;" valign="top"><![endif]-->
            <a href="https://unlayer.com" target="_blank" class="v-button v-font-size" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #14b99f; border-radius: 30px;-webkit-border-radius: 30px; -moz-border-radius: 30px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
